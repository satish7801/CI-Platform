...
public partial class CiPlatformContext : DbContext
{
    ...
    public virtual DbSet<MissionAplication> MissionAplications { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=PCI137\\SQL2017;DataBase=Ci_Platform;User ID=sa;Password=tatva123;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AB7D29DA38A3F3");

            entity.ToTable("admin");

            entity.HasIndex(e => e.Email, "UQ__admin__AB6E61648191AADD").IsUnique();
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__1036386C44F172EF");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031385D07B4772E7");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B4622F4A9B0BB6B0");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E7EC515F22C1C746");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E95F50D51BA84E3");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favourit__94E3C3D2294D82BC");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358F06EF163E0F3B");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5429E9ABB065610");
        ...
        modelBuilder.Entity<MissionAplication>(entity =>
        {
            entity.HasKey(e => e.MissionAplicationId).HasName("PK__mission___38B9D0A9A56AB5C6");

            entity.ToTable("mission_aplication");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionAplications)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_mission_missionIdma");

            entity.HasOne(d => d.User).WithMany(p => p.MissionAplications)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80F08F026BC61FC");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97FDD2059A7DA4E");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848B7CD0ED9F1FED");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320F555AAFAE902D");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___827C35D0650233AF");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4924F9946C6730C7");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBB987A1BDF8F312");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__6634982E48DE189C");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__044A7C1FCA95BF8D");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BE0914E0EF314C");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBE5C506EDE1667");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__users__B9BF33275416807B");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD0663E30368CF0E");
